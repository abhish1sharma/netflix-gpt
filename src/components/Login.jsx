...
const Login = () => {
  ...
  return (
    <div>
      ...
      <div className="">
        <img
          className=" w-full objec-cover h-screen"
          src={netflixBg}
      ...
      <form
        className="md:w-1/4 w-full bg-black opacity-75  absolute top-1/2 left-1/2 -translate-1/2 text-white p-16 flex justify-center items-start flex-col rounded-lg"
